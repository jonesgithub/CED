...
def _cedissue_event_handle(sender,instance,**kwargs):
    ...
    thisevent=ced_events(
        ...
        eventdes=u"<a href='%s' title='查看问题单详情' target='_blank'>【#%s】问题单被【%s】置为【%s】</a>" % (thisissue.issuedetailurl,thisissue.issueid,thisissue.issuesubman,thisissue.issuestatusname)
    )
